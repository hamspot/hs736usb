...
From this directory, `firmware` is enough. Libraries: **AltSoftSerial**, **Wire**. LCD is a bare HD44780 on an MCP23017 (default) or MCP23008 (`-DHS736_MCP=8`), not an I2C backpack. `-DHS736_MCP=0` omits LCD, encoder, and I2C. See `docs/WIRING.md`.

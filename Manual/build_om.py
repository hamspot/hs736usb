    ...
    story.append(
        om_table(
            ...
            [
                ...
                ["D11", "in", "MCP INT (encoder); unused if expander off"],
                ["D12", "in", "Encoder SW on MCP23008; free on MCP23017"],
                ["A4, A5", "I2C", "SDA/SCL to MCP23008 or MCP23017"],
    ...
    story.append(
        om_table(
            ...
            [
                ...
                ["J_LCD", "16-pin HD44780", "parallel from MCP23017; RV1 contrast; no backpack"],
                ["J_ENC", "5 V GND A B SW", "KY-040; short press digit, long press mode"],
            ],
